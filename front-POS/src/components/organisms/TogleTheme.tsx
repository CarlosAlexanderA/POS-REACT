...
export function TogleTheme() {
  ...
  return (
    <div className="flex justify-center ">
      <label className="toggle w-12 h-12 rounded-full grid  place-items-center relative">
        <input
          id="switch"
        ...
        {/* Moon */}
        <span className="absolute w-10 col-start-1 row-start-1 transition-transform duration-500 delay-200 scale-100 peer-checked:scale-0 peer-checked:rotate-360 ">
          <svg
        ...
        {/* Sun */}
        <span className="absolute w-10 col-start-1 row-start-1 transition-transform duration-500 scale-0 peer-checked:scale-100 peer-checked:rotate-360">
          <svg
            xmlns="http://www.w3.org/2000/svg"
